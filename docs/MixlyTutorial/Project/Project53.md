...
![image-20251209185142066](./media/image-20251209185142066.png)
...
![image-20251209193811176](./media/image-20251209193811176.png)

再按一下按键，按键次数为7，余数为7，实验实现的功能是利用超声波模块检测距离并在串口打印出来，串口监视器显示图下图。

![image-20251209193827849](./media/image-20251209193827849.png)
