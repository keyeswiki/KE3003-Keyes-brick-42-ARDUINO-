...
![](media/image-20251023112800311.png)

## 4.测试代码

![](media/image-20251023112856277.png)

## 5.代码说明

1. 在实验中，在  ![](media/image-20251023110243239.png)单元内，找到以下元件。

![](media/image-20251023112957855.png)

2. 在上一实验中，当检测到按键信号时，信号端为低电平，即item为0。在这一实验中，当检测到按键信号时，信号端为高电平，即item为1。

![](media/image-20251023113026839.png)
...
![image-20251209194222654](./media/image-20251209194222654.png)
