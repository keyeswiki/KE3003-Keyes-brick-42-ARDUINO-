...
![](media/image-20251023155650773.png)

## 4.测试代码

![](media/image-20251023155705616.png)

## 5.代码说明

1. 在![](media/image-20251023110243239.png)单元内，找到以下元件。

![](media/image-20251023155744567.png)

![](media/image-20251023155752555.png)

2. 实验中，设置了当模拟值低于150时LED亮起，否则熄灭。

## 6.测试结果

上传测试代码成功，利用USB线上电后，打开串口监视器，设置波特率为9600。串口监视器显示对应模拟值。实验中，我们把光线传感器用手握住，数据变小，小于150时，LED模块上LED亮起，否则熄灭。

![image-20251209150813992](./media/image-20251209150813992.png)