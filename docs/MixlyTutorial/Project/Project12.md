...
实验中，通过读取模块上S端高低电平，判断传感器弹片是否下压；并且在串口监视器上显示测试结果。
...
![](media/image-20251023115746137.png)

## 4.测试代码

![](media/image-20251023115802501.png)

## 5.代码说明

在![](media/image-20251023110243239.png)单元内，找到以下元件。

![](media/image-20251023115841142.png)
...
![image-20251209194758506](./media/image-20251209194758506.png)