...
2\. 点击“**File** ——>**Preferences...**”，在**Preferences**对话框中，单击 “**Language**” 后方的选项你可以选择你习惯的语言然后单击 “**OK**”.
...
5. “帮助(H)”点击这个可以查看IDE版本以及官方的参考文件
6. “串口绘图仪”它会将串口的数据以折线图的样式显示出来
7. “串口监视器”可以将我们需要查看的数据在这里进行打印显示
8. 验证程序按钮
9. 验证并上传程序按钮
10. “项目文件夹”可以新建项目，还可以使用arduino Cloud进行同步和编辑
...
2\. 导航到库文件所在的目录（在`2.1 代码和库文件下载`中下载的ZIP文件解压），打开文件`Arduino 库文件`然后选择 `Encoder.zip`文件。
